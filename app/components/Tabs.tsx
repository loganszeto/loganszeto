      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between py-2">
          ...
          <div className="flex gap-4">
            <a href="https://github.com/loganszeto" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#e6c384] transition-colors">
            ...
            <a href="https://linkedin.com/in/loganszeto" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#e6c384] transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
