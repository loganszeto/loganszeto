    ...
    <div className="flex flex-col min-h-screen px-6 sm:px-8 lg:px-12 pt-24 pb-24">
      <div className="max-w-2xl w-full mx-auto space-y-10">
        <section className="space-y-6">
          ...
          <p className="text-[#969696] text-base leading-relaxed max-w-2xl">
        ...
        <section className="space-y-3">
          ...
          <p className="text-[#969696] text-base leading-relaxed max-w-3xl">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc list-inside text-[#969696] text-base leading-relaxed space-y-2">
        ...
        <section className="space-y-2">
          <a
            ...
            className="text-[#c8c8c8] hover:text-white transition-colors text-base"
          >
            GitHub Repo →
          </a>
        </section>
